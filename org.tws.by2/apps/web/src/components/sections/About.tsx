    ...
    return( 
        <section className="flex items-center justify-center ">
            <div className="flex flex-col gap-7 pb-36 justify-center text-center items-center">
                {/* Titulo */}
                <h2 className="text-3xl font-medium text-lightGrayFHT">Como funciona a Plataforma da FHT</h2>
                {/* Cards */}
                <div className="grid grid-cols-1 w-full px-5 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    
                    <div className="flex flex-col justify-center items-center text-center gap-4 rounded-2xl shadow p-4 w-full bg-white hover:shadow">
                    ...
                    <div className="flex flex-col justify-center items-center text-center gap-4 rounded-2xl shadow h-50 p-4  bg-white">
                        <div className="bg-lightBlueFHT w-15 h-15 rounded-full flex items-center justify-center">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640" className="w-10">
                    ...
                    <div className="flex flex-col justify-center items-center text-center gap-4 rounded-2xl shadow p-4  bg-white">
                        <div className="bg-lightBlueFHT w-15 h-15 rounded-full flex items-center justify-center">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640" className="w-10">
